...
void CfgWidget::setSize(int width, int height){
...
void CfgWidget::drawValueGui(ValueGui & value_gui, std::string s, double value){
    int x1 = m_width*0.1;
    int x3 = m_width*0.45;
...
void CfgWidget::onMouse(ValueGui & keypad, double x, double y, double pas){
...
int CfgWidget::onMouse(int x, int y){
